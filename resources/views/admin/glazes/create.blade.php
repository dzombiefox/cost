...
function disable(){
  $(".glazeName").attr("disabled","disabled");
  $(".volume").attr("disabled","disabled");
}
function enable(){
   $(".glazeName").val("");
   $(".volume").val("");
   $(".glazeName").removeAttr("disabled");
        ...
        <div class="col-md-12">
         ...
         <div class="box-header with-border">
              <h3 class="box-title">Master Glaze</h3>
                        ...
                        @endif
                        {!! Form::open(['url' => '/admin/glazes', 'class' => 'form-horizontal','id' => 'form-save', 'files' => true]) !!}
...
<div class="box box-primary">
 ...
 <div class="col-md-12">
    {!! Form::text('dvolume', null, ['class' => 'form-control sel','autocomplete'=>'off']) !!}
        ...
        <input type="text" class="id readonly" name="glazeId" readonly="readonly" />
  ...
  <div class="modal fade" id="modal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         {!! Form::open(['url' => '/glazes/all', 'class' => 'form-horizontal','id'=>'form-all', 'files' => true]) !!}
                        <input type="hidden" class="id" name="glazeId"/>
           <div class="form-group">
   <label class="control-label col-sm-1">Engobe</label>
   <div class="col-md-12">
 <select name="dglazeId" class="item" style="width: 100%">      
      @foreach($glaze as $data)
