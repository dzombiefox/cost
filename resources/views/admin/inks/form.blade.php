<div class="form-group {{ $errors->has('inkName') ? 'has-error' : ''}}">
    {!! Form::label('inkName', 'Inkname', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('inkName', null, ['class' => 'form-control']) !!}
        {!! $errors->first('inkName', '<p class="help-block">:message</p>') !!}
    </div>
</div>
