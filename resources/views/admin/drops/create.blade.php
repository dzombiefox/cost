...
function disable(){
  $(".dropName").attr("disabled","disabled");
  $(".volume").attr("disabled","disabled");
}

function enable(){
  $(".dropName").removeAttr("disabled");
...
<section class="content-header">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div class="box-header with-border">
              <h3 class="box-title">Master Drops</h3>
            </div>
 ...
 @if ($errors->any())
                        ...
                        {!! Form::open(['url' => '/admin/drops', 'class' => 'form-horizontal','id' => 'form-save', 'files' => true]) !!}
 ...
 <div class="col-md-12">
    {!! Form::text('dvolume', null, ['class' => 'form-control sel','autocomplete'=>'off']) !!}
        ...
        <div class="modal-footer">
          <input type="text" class="id readonly" name="dropId" readonly="readonly" />
  ...
  <div class="modal fade" id="modal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        {!! Form::open(['url' => '/drops/all', 'class' => 'form-horizontal','id'=>'form-all', 'files' => true]) !!}
                    
           <div class="form-group">
   <label class="control-label col-sm-1">Engobe</label>
   <div class="col-md-12">
<select name="ddropId" class="item" style="width: 100%">      
                @foreach($drop as $data)
