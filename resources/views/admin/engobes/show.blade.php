                                  ...
                                  @endforeach 
                                   <tr >
                                    ...
                                    <tr class="alt">
                                        ...
                                        <td style="text-align: right">{{App\Http\Controllers\admin\EngobesController::getWeightDry($item->engobe_id)}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">Cost Dry</td>
                                        <td style="text-align: right">                                            
                                            {{App\Http\Controllers\admin\EngobesController::getCostDry($item->engobe_id,$item->periode_id,$item->year)}}
                                        </td>
                                    </tr>
                                    <tr>
