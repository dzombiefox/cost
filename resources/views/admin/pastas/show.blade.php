   ...
   <section class="content-header">
     <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('admin/pastas')}}">Patas</a></li>
                   ...
                   @foreach($pastas as $item)
                               ...
                               ?>
                                    ...
                                    <tr class="alt">
                                        ...
                                        <td style="text-align: right">{{App\Http\Controllers\admin\PastasController::getWeightDry($item->pasta_id)}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">Cost Dry</td>
                                        <td style="text-align: right">                                            
                                            {{number_format(App\Http\Controllers\admin\PastasController::getCostDry($item->pasta_id,$item->periode_id,$item->year),2)}}
                                        </td>
                                    </tr>
                                    <tr>
