...
<table class="table table-bordered table-hover" id="example">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th> Size </th>
                                        <th> Color</th>
                                        <th><a href="{{ url('/admin/pastas/create') }}" title="Back" class="pull-right"><button class="btn btn-warning btn-sm"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Formula Pasta</button></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($pastas as $item)
                                    <tr>
                                        ...
                                        <td style="width: 15%">
                                            ...
                                            <a href="{{ url('/admin/pastas/' . $item->pasta_id . '/edit') }}" class="btn btn-primary fa fa-edit" ></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/admin/pastas', $item->pasta_id],
