...
<section class="content-header">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            @if ($errors->any())
                        ...
                        {!! Form::open(['url' => '/admin/types', 'class' => 'form-horizontal', 'files' => true]) !!}
                          <div class="box-body">
    ...
    <div class="input-field col s12">
    <label>Density</label>
    <select name="densityId" class="form-control density">      
      @foreach($density as $data)
      <option value="{{$data->density_id}}">{{$data->densityName}}</option>
      @endforeach
    </select>
